  ...
  return (
    <div className=" flex flex-col w-full justify-center items-center mt-4 ">
      <div className=" flex justify-center items-center flex-col w-1/3 border rounded-lg">
        <h1 className=" text-2xl font-semibold uppercase text-center w-full mb-4 text-white p-4 rounded-t-lg bg-blue-400 ">Sign In</h1>
        <div className=" w-full p-8 ">
          <form onSubmit={handleSubmit} className=" w-full flex flex-col gap-8 justify-center items-center " >
            ...
            <button type="submit" className=" border-blue-500 bg-blue-500 p-2 px-4 text-white rounded-md ">Sign In</button>
